...
<body>
    ...
    //echo "$nome,- $sexo,- $cep,- $cpf,- $estado, -$municipio";
    //exit();
    $cpfform = formato($cpf);
    //echo"$cpfform";
    //exit;
    ...
    if ($contanome > 50) {
        ...
        $query = "UPDATE entregador SET nome = '$nome', rg = '$rg', cpf = '$cpfform', rua='$rua', numero = '$numero', cep = '$cep', complemento = '$complemento', telefone = '$telefone', sexo = '$sexo', celular = '$celular', email = '$email', senha = '$senhas', id_estado = '$estado', id_cidade = '$municipio' WHERE id_entregador = $_SESSION[id_entregador]";
        //print_r($query);
        // exit;
