...
<head>
    ...
    <title>Atualizar entregador</title>
</head>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav me-2 ms-auto">
                    ...
                    if (isset($_SESSION['id_cliente']) &&  isset($_SESSION['nome']) && isset($_SESSION['email'])) {
                        ...
                        echo "
                            <li class='nav-item '>
                                <a class='active bi bi-person-fill nav-link' href='perfile.php'>&nbsp; Perfil</a>
                            </li>
                        ";
                    }
                    ?>
    ...
    <div class="">
        ...
        $query = "SELECT id_entregador, entregador.nome AS nomeentrega, estado.nome AS nomeestado, cidade.nome AS nomecidade, sexo, senha, email, telefone, cpf, rg, celular, rua, numero, complemento, cep, entregador.id_estado AS idestado, entregador.id_cidade AS idcidade FROM entregador INNER JOIN estado ON estado.id_estado = entregador.id_estado INNER JOIN cidade ON cidade.id_cidade = entregador.id_cidade WHERE id_entregador = $id";
        $exec = mysqli_query($conexao, $query);

        $entregador = mysqli_fetch_assoc($exec);
        ...
        <div>
            ...
            <div class="m-4 jumbotron">
                <h1 class="display-4"><i class="fas fa-address-card"></i> Editar entregador</h1>
                <hr class="my-4">
            </div>

            <form action="atualizar-entregador-processa.php" method="POST" class="container">

                <div class="mb-3">
                    <h5 class="form-label"><i class="fas fa-dice"></i>&nbsp; Dados pessoais</h5>
                    <input class="form-control" type="text" name="nome" maxlength="" placeholder="Digite seu nome" required="required" value="<?php echo $entregador['nomeentrega']; ?>"><br>
                    <input class=" form-control" type="text" name="rg" placeholder="Digite o RG" required="required" value="<?php echo $entregador['rg']; ?>"><br>
                    <input class="form-control" type="text" name="cpf" placeholder="Digite o CPF" required="required" value="<?php echo $entregador['cpf']; ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="email" name="email" placeholder="Digite seu e-mail" required="required" value="<?php echo $entregador['email']; ?>"><br>
                    <input class="form-control" type="password" name="senha" placeholder="Digite sua senha" required="required" value="<?php echo $entregador['senha']; ?>">
                </div>
                <div class="mb-3">
                    <h5 class="form-label"><i class="fas fa-phone-square-alt"></i>&nbsp; Telefones</h5>
                    <input class="form-control" type="text" name="telefone" placeholder="Digite o telefone residencial" value="<?php echo $entregador['telefone']; ?>"><br>
                    <input class="form-control" type="text" name="celular" placeholder="Digite o telefone celular" value="<?php echo $entregador['celular']; ?>">
                </div>
                <div class="mb-3">
                    <h5 class="form-label"><i class="fas fa-map-marked-alt"></i>&nbsp; Endereço</h5>
                    <input class="form-control" type="text" name="rua" placeholder="Digite o nome da rua." required="required" value="<?php echo $entregador['rua']; ?>"><br>
                    <input class="form-control" type="text" name="numero" placeholder="Digite o número da rua." required="required" value="<?php echo $entregador['numero']; ?>"><br>
                    ...
                    <!-- <i class="bi bi-info-square-fill flex-shrink-0 align-items-center me-1 alert alert-warning" role="alert">&nbsp; Complemento opcional.</i>
                             -->
                    <div class="d-flex">
                        <textarea class=" me-2 form-control" data-bs-toggle="collapse" data-bs-target="#collapseExample" name="complemento" placeholder="Digite o complemento"><?php echo $entregador['complemento']; ?></textarea>
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body alert-success ">Complemento opcional.</div>
                        </div>
                    </div><br>
                    <input class="form-control" type="text" name="cep" placeholder="Digite o CEP" required="required" value="<?php echo $entregador['cep']; ?>"><br>

                    <select class="form-select" name="estados" id="estados">
                        <?php
                        echo "<option value='$entregador[idestado]'>$estado1</option>";
                        ...
                        echo "
                            ...
                            <option value='$entregador[idcidade]'>$city1</option>
                            ";
                ...
                <div class="btn-group d-flex col-4 mb-4 justify-content-md-start">
                    ...
                    <input type="hidden" name="id" value="<?php echo $entregador['id_entregador']; ?>">
                </div>
            </form>
        </div>
    </div>
