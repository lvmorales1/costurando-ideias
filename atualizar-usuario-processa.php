...
<body>
    ...
    if ($contanome > 50) {
        ...
        $query = "UPDATE cliente SET nome = '$nome', rg = '$rg', cpf = '$cpfform', rua='$rua', numero = '$numero', cep = '$cep', complemento = '$complemento', telefone = '$telefone', sexo = '$sexo', celular = '$celular', email = '$email', senha = '$senhas', id_estado = '$estado', id_cidade = '$municipio' WHERE id_cliente = $_SESSION[id_cliente]";
        //print_r($query);
        // exit;
