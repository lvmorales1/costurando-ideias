                    ...
                    if (empty($_SESSION['nome']) && empty($_SESSION['email'])) {
                        ...
                        <li class='nav-item dropdown'>
                            ...
                            <div class='dropdown-menu dropdown-menu-end success'>
                                ...
                                <a class='dropdown-item active' href='cadastrar-entregador.php'><i class='fas fa-shipping-fast'></i> Cadastrar entregador</a>
                            </div>
                        </li>
                         <li>
    ...
    <div class="">
        ...
        <div>
            ...
            <div class="m-4 jumbotron">
                <h1 class="display-4"><i class="fas fa-address-card"></i> Cadastrar entregador</h1>
                <hr class="my-4">
            </div>

            <form action="cadastrar-entregador-process.php" method="POST" enctype="multipart/form-data" class="container">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <div class="mb-3">
                        <h5 class="form-label"><i class="fas fa-fingerprint"></i>&nbsp; Documento e foto</h5>
                        <label for="exampleFormControlInput1" class="form-label">Foto da CNH:</label>
                        <input type="file" class="form-control" name="doc" placeholder="Foto do CNH" required="required"><br>
                        <label for="exampleFormControlInput1" class="form-label">Foto de rosto:</label>
                        <input type="file" class="form-control" name="foto" placeholder="Foto" required="required">
                    </div>
