...
<body>
  ...
  <div class="text-center m-4 card shadow">
    ...
    <div class="" id="content-notifi"></div>
    <div class="d-flex m-4">
      <button type="button" onclick="window.location.href='statuspedidoentregador.php'" class="btn btn-outline-warning" value=" <?php echo $_SESSION['id_entregador']; ?>"><i class='fas fa-chevron-left'></i>&nbsp; Voltar</button>
    </div>
  </div>
