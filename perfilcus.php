...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav me-2 ms-auto">
                    ...
                    if (isset($_SESSION['id_cliente']) &&  isset($_SESSION['nome']) && isset($_SESSION['email'])) {
                        ...
                        echo "
                            <li class='nav-item'>
                                <a class='bi bi-person-fill active nav-link' href='perfilcus.php'>&nbsp; Perfil</a>
                            </li>
                        ";
    ...
    <div class="m-4 p-3 card shadow rounded-3 align-text-center d-flex">
        ...
        $query = "SELECT id_costureira, costureira.nome AS nomecostureira, estado.nome AS nomeestado, cidade.nome AS nomecidade, sexo, email, telefone, cpf, rg, celular, rua, numero, complemento, cep, costureira.id_estado AS idestado, costureira.id_cidade AS idcidade FROM costureira INNER JOIN estado ON estado.id_estado = costureira.id_estado INNER JOIN cidade ON cidade.id_cidade = costureira.id_cidade  WHERE id_costureira = $_SESSION[id_costureira]";
        $exec = mysqli_query($conexao, $query);


        while ($costureira = mysqli_fetch_array($exec)) {
            ...
            // $queryestado = "SELECT id_estado, nome FROM estado WHERE id_estado = $costureira[id_estado]";
                ...
                <div class='align-center d-grid gap-2 mx-auto d-flex'>
                    ...
                    <h4 class='me-5 p-3'><i class='fas fa-dice'></i>&nbsp; Dados pessoais</h5>
                        <div class='mb-3 d-flex'>
                            <div class='m-3'>    
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-id-card-alt'></i>&nbsp; Nome:</b>&nbsp; <p>$costureira[nomecostureira]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-at'></i>&nbsp; E-mail:</b>&nbsp; <p>$costureira[email]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-id-card'></i>&nbsp; RG:</b>&nbsp; <p>$costureira[rg]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-id-card'></i>&nbsp; CPF:</b>&nbsp; <p>$costureira[cpf]</p>
                                </span>
                    ...
                    <h4 class='me-5 p-3 '><i class='fas fa-phone-square-alt'></i>&nbsp; Telefones</h5>
                        <div class='mb-3 d-flex'>
                            <div class='m-3'>    
                                <span class='mb-4 d-flex fs-5'><b><i class='fas fa-phone-alt'></i>&nbsp; Telefone:</b>&nbsp; <p>$costureira[telefone]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-mobile-alt'></i>&nbsp; Celular:</b>&nbsp; <p>$costureira[celular]</p>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <h4 class='me-5 p-3 '><i class='fas fa-map-marked-alt'></i>&nbsp; Endereço</h5>
                        <div class='mb-3 d-flex'>
                            <div class='m-3'>    
                                <span class='mb-2 d-flex fs-5'><b><i class='fas fa-map-marker-alt'></i>&nbsp; Rua:</b>&nbsp; <p>$costureira[rua]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><i class='fas fa-sort-numeric-up'></i>&nbsp; <b>Número:</b>&nbsp; <p>$costureira[numero]</p>
                                </span>
                                <span class='mb-4 d-flex fs-5'><i class='fas fa-map-pin'></i>&nbsp; <b>Complemento:</b>&nbsp; <p>$costureira[complemento]</p>
                                </span>
                                <span class='mb-2 d-flex fs-5'><i class='fas fa-location-arrow'></i>&nbsp; <b>CEP:</b>&nbsp; <p>$costureira[cep]</p>
                                </span>
                                ";
            $estado = mysqli_fetch_array($executar2);
            $estad = utf8_encode($estado['nome']);
            echo "
                                <span class='mb-2 d-flex fs-5'><i class='fas fa-map'></i>&nbsp; <b>Estado:</b>&nbsp; <p>$estad</p>
                                </span>";

            $cidade = mysqli_fetch_array($executar3);
            $city = utf8_encode($cidade['nome']);
            echo "<span class='mb-2 d-flex fs-5'><i class='fas fa-map-marked-alt'></i>&nbsp; <b>Cidade:</b>&nbsp; <p>$city</p>
                                    </span>";
            echo "
                            </div>
                        </div>
                ...
                <hr class='m-4'>
                <div class='d-flex'>
                <div class='btn-group d-flex col-5 p-3 justify-content-md-start'>
                <a href='index.php' id='button' type='submit' class='btn btn-outline-warning'><i class='fas fa-chevron-left'></i>&nbsp; Voltar</a>
                <a href='atualizar-costureira.php?id=$costureira[id_costureira]' id='button' type='submit' class='btn btn-outline-primary'><i class='fas fa-edit'></i>&nbsp; Editar informações</a>
                 <a id='button' href='cadastro-servicos.php' type='submit' class='btn btn-outline-success' name='cadastrar'><i class='fas fa-cut'></i>&nbsp; Cadastrar serviços</a>
                    </div>
                    <div class='m-3 d-flex col d-md-flex justify-content-md-end'>
                        <a href='deletar-costureira.php?deleteid=$costureira[id_costureira]' id='button' type='submit' class='btn btn-outline-danger'><i class='fas fa-user-minus'></i>&nbsp; Deletar conta</a>
                    </div>
                </div>              
