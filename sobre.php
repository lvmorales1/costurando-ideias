...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav me-2 ms-auto">
                    ...
                    ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="sobre.php"><i class="fas fa-info-circle"></i>&nbsp; Sobre nós</a>
                    </li>
                    <?php
    ...
    <div class="card shadow m-4 rounded-3">
        <div class="px-4 pt-5 m-4 text-center">
            <h1 class="display-4 fw-bold"><i class="fas fa-info-circle"></i>&nbsp;Sobre nós</h1>
            <div class="mx-auto">
                <p class="text-center lead m-4">
                    Somos uma equipe de estudantes empenhados no intuito de obtermos aprovação satisfatória no trabalho de conclusão de
                    curso exigido pela instituição de ensino <b>ETEC</b> através do projeto <b>Costurando Ideias</b>, mas antes de tudo somos seres humanos
                    que prezamos pela sustentabilidade, e pelo bem-estar do próximo para a preservação do planeta e assim obtermos um mundo
                    melhor. Então elaboramos esse projeto, especialmente, a fim de atender as necessidades ambientais, em auxiliar na redução do
                    impacto causado pelas industriais têxteis que além da demanda, o alto índice de lucratividade e emprego gera um amplo
                    desperdício desconhecido pela humanidade, que corrobora com o aquecimento global, no qual dia após dia vem causando
                    danos que em breve se tornarão irreversíveis a nação.
                    Então esse projeto é dedicado a todos que se preocupam com o meio ambiente e desejam fazer algo para essa causa e não
                    sabem como podem auxiliar em amenizar o impacto causado pela indústria da moda.
                    A ideia começou devido a pandemia que exigia que ficássemos em casa com a junção de nos depararmos diariamente com
                    diversas notícias avassaladoras sobre o impacto negativo no meio ambiente, e com isso unimos praticidade, comodidade,
                    necessidade, economia e a nossa contribuição em amenizar o impacto causado pela indústria da moda, onde o cliente poderá
                    realizar ajustes e remodelar suas peças de roupas de acordo com suas necessidades, e com esse ato contribuindo de forma
                    ampla e significativa para um mundo melhor e sustentável.
                </p>
