  ...
  <div class="m-4 card shadow">
    <table class="table align-center text-center table-hover">
      <thead>
        ...
        <th scope='col'><i class="fas fa-money-bill-wave"></i>&nbsp; Valor pago</th>
      ...
      $id_cli = $_SESSION['id_cliente'];
      $query = "SELECT id_pedido, data_pedido, prazo, descricao, valor,situacao FROM pedido WHERE id_cliente_pedido = $id_cli ";
      ...
      while ($mostrar = mysqli_fetch_assoc($executarr)) {
        ...
        echo "
            ...
            <tr class='align-center'>
                ...
                <td scope='row'>R$ $mostrar[valor],00</td>
                <td>
                ";
        ...
        if ($mostrar['situacao'] == 1) {
          echo "<i class='fas fa-shipping-fast'></i>&nbsp; Aguardando entregador
          <div class='progress mt-2'>
        ...
        if ($mostrar['situacao'] == 6) {
          ...
          echo "
                      <form action='processstatus.php' method='post'>
                        ...
                        <input type='checkbox' checked class='hidden' name='novositu' value='7' style='display:none;'/>
                        <button id='button' class='btn btn-outline-success' type='submit class='btn-outline-success' name='id_pedido' value='$mostrar[id_pedido]'><i class='fas fa-check-circle'></i>&nbsp; Confirmar entrega</button>
                      </form> ";
        }
        echo "   
                </td>
    ...
    <div class="d-grid d-md-flex mb-4 ms-4">
